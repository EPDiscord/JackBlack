  ...
  execute: async inter => {
    ...
    if (candaily.length) { // if anything was returned
      ...
      if (d >= inter.client.xconfig.daily) {
        ...
        await inter.reply(`Successfully claimed daily of \`${inter.client.currency}${inter.client.xconfig.daily}\`!`);
      }
    } else {
